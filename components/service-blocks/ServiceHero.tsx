...
export default function ServiceHero({
  ...
  return (
    <section className="relative w-full min-h-[460px] flex items-center bg-primary overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 py-16 lg:py-20">
        <Link
          href={`/${locale}/#services`}
          className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-bronze hover:text-white transition-colors mb-6 group"
        >
        ...
        <div className="max-w-2xl space-y-4">
          ...
          <div className="pt-3 flex flex-wrap items-center gap-4">
            <a
              href="#pricing"
              className="px-6 py-3.5 rounded-xl bg-bronze hover:bg-bronze-dark text-white font-bold text-xs uppercase tracking-wider transition-all shadow-lg hover:shadow-bronze/30"
            >
              {isVi ? "Xem Bảng Giá Tham Khảo" : "View Reference Pricing"}
            </a>
            <a
              href="tel:0276666510"
              className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl border border-white/30 text-white hover:bg-white/10 text-xs font-bold transition-all backdrop-blur-sm"
            >
